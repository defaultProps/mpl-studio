<template>
  <div class="mpl-pane-box">
    基础面板
    1, 演示标准查询编辑页面内容[左侧tree, 右侧查询 + 表格. 内置弹框编辑新增, 批量编辑, 统计可视化图表, 表格是一个ag-grid图表, 表格头增加导入导出删除.
    弹框新增是一个表单 +
    输入表格的复杂新增功能.]

    <!-- 一个表单[表单组件], 一个表格[ag-grid表格内容]. 一个面板[面板排版] -->
    <el-form ref="ruleFormRef" style="max-width: 600px" :model="ruleForm" :rules="rules" label-width="auto">
      ...
      <el-form-item label="电话号码" prop="count">
        <el-select-v2 v-model="ruleForm.count" placeholder="Activity count" :options="options" />
      </el-form-item>
      <el-form-item label="企业类型" prop="count">
        <el-select-v2 v-model="ruleForm.count" placeholder="Activity count" :options="options" />
      </el-form-item>
      <el-form-item label="企业规模" prop="count">
        <el-select-v2 v-model="ruleForm.count" placeholder="Activity count" :options="options" />
      </el-form-item>
      <el-form-item label="企业" prop="count">
        <el-select-v2 v-model="ruleForm.count" placeholder="Activity count" :options="options" />
      </el-form-item>
