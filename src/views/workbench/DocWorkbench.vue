    ...
    mplDocIframe.postMessage(
      {
        ...
        payload: {
          assetsFilePath: project.activeFileId ? `./markdown/${project.activeFileId}.md` : ''
        }
      },
      '*'
    )
...
<template>
  <div class="mpl-doc--container">
    ...
    <iframe src="/src/iframe/docs/index.html" name="mplDocIframe" frameborder="0" class="mpl-doc-iframe"
      @load="loadIframe" />
  </div>
</template>
