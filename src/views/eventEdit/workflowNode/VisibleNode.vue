...
<template>
  <div class="dialog-visible-node mpl-event-flow-node" :class="{ 'is-error': !selectNode, 'is-collapse': isCollapse }">
    ...
    <div class="line-box">
      ...
      <div class="content">
        <select v-model="selectNode" placeholder="请选择">
          <option v-for="item in dialogNodes" :key="item.value" :label="item.label" :value="item.value" />
        </select>
      </div>
    </div>
