...
function loadIframe() {
  mplIframePostMessage.preview.initPlatformMenu(project.projectTree)
}
...
<template>
  <div class="iframe--container mpl-scroll-none" :style="{ width: width + 'px', height: height + 'px' }">
    <iframe id="workbench" src="/src/platform/mpl-app/preview/index.html" name="PreviewIframe" @load="loadIframe" />
...
.iframe--container {
  background-image: linear-gradient(90deg, rgba(180, 180, 180, 0.18) 10%, rgba(0, 0, 0, 0) 10%),
