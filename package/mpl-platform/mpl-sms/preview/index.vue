...
onMounted(() => {
  window.addEventListener('message', e => {
    ...
    if (obj.type === 'INIT_PROJECT_DIR') projectTree.value = JSON.parse(obj.payload.projectTree)

    if (obj.type === 'UPDATE_ACTIVE_PAGE') defaultActiveMenu.value = obj.payload.id
  })
})
</script>
    ...
    <div class="content-box">
      <div class="header-box">
        <div class="trigger-btn" @click="isCollapseMenu = !isCollapseMenu">
          <i class="mpl icon" :class="[isCollapseMenu ? 'mpl-double-arro-right' : 'mpl-double-arrow-left']" />
        </div>
      </div>
