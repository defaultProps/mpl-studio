...
import { newSwitchNode, switchNode, type SwitchFormProp } from './define'
...
export default <SettingMap>{
  ...
  generator: {
    elementPlus: async (node: SwitchFormProp) => (await import('./generator/ElementPlus')).default(node),
    vant4: async (node: SwitchFormProp) => (await import('./generator/Vant4')).default(node),
    antDesign: async (node: SwitchFormProp) => (await import('./generator/AntDesign')).default(node),
    antDesignMobile: async (node: SwitchFormProp) => (await import('./generator/AntDesignMobile')).default(node),
    vars: async (node: SwitchFormProp) => (await import('./generator/ref')).default(node)
  }
}
