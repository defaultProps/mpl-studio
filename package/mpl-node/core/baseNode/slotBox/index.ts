...
import { slotBox, newSlotBox, type SlotBoxProp } from './define'
...
export default <SettingMap>{
  ...
  generator: {
    elementPlus: async (node: SlotBoxProp) => (await import('./generator/ElementPlus')).default(node),
    vant4: async (node: SlotBoxProp) => (await import('./generator/Vant4')).default(node),
    antDesign: async (node: SlotBoxProp) => (await import('./generator/AntDesign')).default(node),
    antDesignMobile: async (node: SlotBoxProp) => (await import('./generator/AntDesignMobile')).default(node),
    vars: async (node: SlotBoxProp) => (await import('./generator/ref')).default(node)
  }
}
