...
import { newPanel, panel, type PanelProp } from './define'
...
export default <SettingMap>{
  ...
  generator: {
    elementPlus: async (node: PanelProp) => (await import('./generator/ElementPlus')).default(node),
    vant4: async (node: PanelProp) => (await import('./generator/Vant4')).default(node),
    antDesign: async (node: PanelProp) => (await import('./generator/AntDesign')).default(node),
    antDesignMobile: async (node: PanelProp) => (await import('./generator/AntDesignMobile')).default(node),
    vars: async (node: PanelProp) => (await import('./generator/ref')).default(node)
  }
}
