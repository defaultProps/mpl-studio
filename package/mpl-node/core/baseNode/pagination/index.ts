...
import { newPaginationNode, paginationNode, type Pagination } from './define'
...
export default <SettingMap>{
  ...
  generator: {
    elementPlus: async (node: Pagination) => (await import('./generator/ElementPlus')).default(node),
    vant4: async (node: Pagination) => (await import('./generator/Vant4')).default(node),
    antDesign: async (node: Pagination) => (await import('./generator/AntDesign')).default(node),
    antDesignMobile: async (node: Pagination) => (await import('./generator/AntDesignMobile')).default(node),
    vars: async (node: Pagination) => (await import('./generator/ref')).default(node)
  }
}
